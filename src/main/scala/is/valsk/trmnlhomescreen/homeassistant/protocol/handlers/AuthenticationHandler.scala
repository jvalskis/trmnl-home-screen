...
import is.valsk.trmnlhomescreen.homeassistant.message.model.commands.Auth
import is.valsk.trmnlhomescreen.homeassistant.message.model.responses.{AuthInvalid, AuthOK, AuthRequired}
